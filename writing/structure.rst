...
:定义: https://docs.python.org/zh-cn/3/glossary.html#term-decorator
...
`记忆化 <https://en.wikipedia.org/wiki/Memoization#Overview>`_ 或缓存就是一个很
...
- `@property <https://docs.python.org/zh-cn/3/library/functions.html#property>`_ 返回 property 属性。
- `@classmethod <https://docs.python.org/zh-cn/3/library/functions.html#classmethod>`_ 把一个方法封装成类方法。
- `staticmethod <https://docs.python.org/zh-cn/3/library/functions.html#staticmethod>`_ 将方法转换为静态方法。
...
示例 通过@*.setter装饰器，我们可以方便的设置只读属性，即无法对属性进行修改::
...
.. tip::
    ...
    关于类方法和静态方法，如果要调用类的属性或者实例化对象，使用@classmethod，不涉及到类的属性则应该使用@staticmethod
